...
class actions {
  ...
  make_and_execute_namespace_operation(input, start, end, elements) {
    ...
    try {
      ...
      if (!actions.is_primitive(result.obj) && !(result instanceof _InspectorObjectNamespace.default && result.obj.subtype === 'array')) {
        return new NonPrimitiveNamespaceResult(result, input.substr(start, end));
      }
...
function normalizeResult(result) {
  ...
  return new _JSObjectNamespace.default(result.obj);
}
